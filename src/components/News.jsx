...
export default class News extends Component {
  ...
  async updateNews() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?category=${this.props.category}&country=${this.props.country}&apiKey=ba3a758b7a1e49079bf0d014e17798a8&page=${this.state.page}&pageSize=${this.props.pageSize}`;
